    ...
    >
      <div className="Videopart pt-[50px] lg:pt-[130px] lg:h-[600px] w-full h-[600px] flex flex-row bg-white  cloud-image">
        ...
        <div className=" w-12/12 lg:w-8/12 flex flex-col items-center">
          <div
            className="text-[#028B8A]  text-[20px] font-serif font-semibold"
          ...
          <div className="block  md:hidden text-center">
            <span
              className="hover:text-[#028B8A] font-bold text-[28px] font-serif "
              style={titleFontStyle}
            >
              Explore Your Life,
            </span>
          ...
          <div className="flex">
            <span
              className="hidden md:block  hover:text-[#028B8A] text-[46px] lg:text-[40px] md:text-[36px] sm:text-[32px] font-bold"
              style={titleFontStyle}
            >
              Explore Your Life,
            </span>{" "}
      ...
      {videoElement && (
        <div className=" h-0 z-30 xl:px-[25%] relative top-[-54vh] flex videoelement ">
          ...
          <div>
            <button
              className=" "
              onClick={() => setVideoElement(!videoElement)}
            >
              <CloseIcon className="text-[40px] text-white z-50 bg-transparent font-thin  relative top-[-50px]  " />
            </button>
          </div>
        </div>
      )}
