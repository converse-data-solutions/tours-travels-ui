...
//  ;
//  const [uniqueCountries, setUniqueCountries] = useState<Record<string, StateData>>({});
...
//   return (
//     <div className="grid grid-cols-1    lg:grid-cols-2  px-7 gap-7" >
//        {Object.entries(uniqueCountries).map(([country, data]) => (
//         <div className='w-full'>
//               <div className=' '>
//                 <div className="zoom-effect-container rounded-lg">
//                <Image src={img} className=" w-full h-auto rounded-lg  destination-card" height={100} width={1000} alt="Image" /></div>
