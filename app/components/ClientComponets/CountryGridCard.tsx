  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_DOMAIN}/package/get`, {
          method: "GET",
          headers: {
    ...
    <div className="   w-full  rounded-lg  ">
      ...
      >
        <div className=" w-full h-full outerbox-image rounded-md">
          ...
          <button className="bg-[#029e9d] relative top-[-35px] ml-[50%] xl:ml-[60%] md:ml-[60%]   text-[16px]   px-3 h-[55px]  text-white font-bold rounded-lg "  style={poppins1.style}>
          <div className="flex">
