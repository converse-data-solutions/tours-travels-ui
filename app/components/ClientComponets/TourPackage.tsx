    ...
    <div className="   w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7  rounded-lg  ">
      ...
      >
          <div className=" w-full h-full outerbox-image rounded-md">
            ...
            <button className="bg-[#029e9d] relative top-[-35px] ml-[42%] md:ml-[50%] mr-[3%] xl:mr-[5%] min-w-fit  text-[16px]  xl:ml-[58%]  px-3 mx-5 h-[55px]  text-white font-bold rounded-lg "  style={poppins1.style}>
             <div className="flex gap-1"> <div className="pt-[2px]"><SlCalender/></div><div>{item.days_and_night} Days Tours</div></div>
            </button>

            <div className="card_details1 py- px-7">
              <div className="text-[18px] text-[#029e9d] pb-2 font-bold" style={playFair.style}>
                {item.country}
              </div>
              <div className=" font-bold text-[26px] pb-1 " style={playFair.style}>
                {item.state}
              </div>
              <div className="text-[#fbbc06]  pb-1  ">
                ...
                <span className="text-gray-700 text-[16px]" style={poppins.style}>(12)</span>
              </div>
              <span className="text-[16px] pb-6 text-gray-500  " style={poppins.style}>
                <div
              ...
              <div className=" text-[hsl(187,82%,35%)] pt-2 pb-7">
                <span className="text-[20px] font-bold " style={poppins1.style}>${item.price} </span>
                <span className="text-gray-700 text-[16px] font-thin" style={poppins.style}>
                  &nbsp;|&nbsp;Per person
                </span>
              </div>
            </div>
