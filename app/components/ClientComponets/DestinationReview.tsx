...
const handleChange = (e:any) => {
  ...
  return (
    <div className='pt-4 lg:pt-0' >
        <div className='text-[22px] font-bold' style={playFair.style}>Write A Review</div>
    <form>
        <div className='flex flex-col md:flex-row md:gap-8'>

    <div className='text-[16px]' style={poppins.style}><input
   ...
   <button className='hovering-button py-3 px-5 rounded-lg text-white text-[14px] mt-3' style={poppins.style}> Submit Review</button>
    </form>
    </div>
  )
}
