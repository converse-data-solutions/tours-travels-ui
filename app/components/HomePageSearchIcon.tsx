    ...
    <div className="h-[92vh] pb-16 flex justify-center items-center bg-white">
      <form className="flex flex-col items-center">
        <div className="flex justify-center ">
          <input type="search" placeholder="type keyword(s) here"   className=" inputcontainer py-12 px-10 border-b-2 border-solid border-gray-400 text-xl lg:text-5xl transition duration-300 ease-in-out focus:border-gray-400 focus:outline-none"
/>
