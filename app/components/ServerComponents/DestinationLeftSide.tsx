...
const DestinationLeftSide = () => {
  ...
  return (
    <div>
      <div
        className="text-[28px] lg:text-[46px] font-bold pb-3"
      ...
      <br></br>
      <div className="text-[16px] text-[#777777] pb-2" style={poppins.style}>
      ...
      <div className="text-[16px]  text-[#777777] pb-4" style={poppins.style}>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="px-5 py-6 bg-[#f1f1f1] rounded-lg">
          <div className="text-[18px] font-bold" style={playFair.style}>
            Price Includes
          </div>
          <br></br>
          <div className="text-[16px] text-[#777777] " style={poppins.style}>
            <FontAwesomeIcon icon={faCheck} className="font-bold" /> Air Fares
          </div>
          <div className="text-[16px] text-[#777777]" style={poppins.style}>
            <FontAwesomeIcon icon={faCheck} className="font-bold" /> 3 Nights
            Hotel Accomodation
          </div>
          <div className="text-[16px] text-[#777777]" style={poppins.style}>
            <FontAwesomeIcon icon={faCheck} className="font-bold" /> Tour Guide
          </div>
          <div className="text-[16px] text-[#777777]" style={poppins.style}>
            <FontAwesomeIcon icon={faCheck} className="font-bold" /> Entrance
            Fees
          </div>
        </div>
        <div className="px-5 py-6 bg-[#f1f1f1] rounded-lg ">
          ...
          <br></br>
          <div className="text-[16px] text-[#777777]" style={poppins.style}>
            <FontAwesomeIcon icon={faCheck} className="font-bold" /> Guide
            Service Fee
          </div>
          <div className="text-[16px] text-[#777777]" style={poppins.style}>
            <FontAwesomeIcon icon={faCheck} className="font-bold" /> Driver
            Service Fee
          </div>
          <div className="text-[16px] text-[#777777]" style={poppins.style}>
            <FontAwesomeIcon icon={faCheck} className="font-bold" /> Any Private
            Expenses
          </div>
          <div className="text-[16px] text-[#777777]" style={poppins.style}>
            <FontAwesomeIcon icon={faCheck} className="font-bold" /> Room
            Service Fees
          </div>
        </div>
      </div>

      <div className="text-[22px] font-bold pb-4 pt-7 " style={playFair.style}>
        Gallery
      </div>
      ...
      <div className="w-full flex flex-col md:flex-row md:gap-7 ">
        <div className="rounded-lg lg:w-4/12 items-center flex-col justify-center py-6 px-2  bg-[#17233e] text-white text-center md:w-5/12">
          <div
            className=" text-[28px] md:text-[36px] lg:text-[46px] font-bold"
            style={playFair.style}
          >
            2.2/5
          </div>
          <div className="text-[22px] font-bold pb-1" style={playFair.style}>
            "Feel So Much Worst Than Thinking"
          </div>
          <div className="text-[16px] font-bold" style={poppins.style}>
            From 40 Reviews
          </div>
        </div>
        <div className="w-full pt-4 lg:pt-0 ">
          ...
          <div className="static-reviews mb-2  ">
            <div
              className="filled-section rounded-l-2xl"
              style={{ width: "40%" }}
            ></div>
            <div
              className="unfilled-section rounded-r-2xl"
              style={{ width: "60%" }}
            ></div>
          </div>
