...
import { faCcDiscover, faCcMastercard, faCcPaypal, faCcStripe, faCcVisa } from '@fortawesome/free-brands-svg-icons';
...
const FooterPart = () => {
  ...
  return (
    <div>
     ...
     {/* <div style={{ backgroundImage: `url(https://htmldesigntemplates.com/html/travelin/images/background_pattern.png)` , backgroundRepeat: 'no-repeat',backgroundPosition:'1100px',height:'400px' }} >*/}
     ...
     <div className="bg-[#17233E] h-[1530px] lg:h-[600px] lg:overflow-hidden">
      <div
        ...
        style={{ backgroundImage: `url(https://htmldesigntemplates.com/html/travelin/images/background_pattern.png)` , backgroundRepeat: 'no-repeat',backgroundPosition:'1100px',height:'600px' }}>
        <div className="h-screen lg:max-w-[1290px] ">
          ...
          <div className="  grid grid-cols-1 md:grid-cols-2 md:gap-4 lg:grid-cols-4 text-white text-[16px] lg:gap-0">
            ...
            <div className="mb-[32px] flex flex-col lg:px-2">
              <h2 className=" border-white font-bold text-2xl pb-2">Quick Link</h2>
            ...
            <div className="mb-[32px] flex flex-col lg:px-2">
              <h2 className="  border-white font-bold text-xl pb-2">Categories</h2>
              <hr className="w-12 pb-6 font-extrabold"></hr>
              <div className="flex flex-col gap-4 md:justify-between h-full ">
                <h3>Travel</h3>
                <h3>Technology</h3>
            ...
            <div className="mb-[32px] flex flex-col  lg:px-2">
              <h2 className="  border-white text-xl font-bold pb-2">Newsletter</h2>
              <hr className="w-12 pb-6 font-extrabold" ></hr>
